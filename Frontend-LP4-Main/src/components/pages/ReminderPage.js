  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-purple-600 to-indigo-600 p-6">
      <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-md transition-transform transform hover:scale-105">
        ...
        <h2 className="text-2xl font-bold text-center text-purple-700 mb-4">Crear Recordatorio para Hábito</h2>
        <form onSubmit={handleCreate} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              className="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 transition duration-200"
            />
          </div>
          <div>
        ...
        {createdReminder && (
          <div className="mt-6 p-4 bg-purple-100 rounded-md">
            ...
            <p className="text-sm text-gray-600">El recordatorio ha sido creado exitosamente.</p>
